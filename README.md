...
U okviru ovih radova korišćene su i analizirane sledeće tehnologije:
- **AI/ML:** TinyML, Edge AI, Quantization.
- **Embedded:** ESP32, ARM Cortex-M, MicroPython.
- **Data Streaming:** LSL (Lab Streaming Layer), BLE (Bluetooth Low Energy).

---

## 📊 Kontakt i Informacije
**Autor:** Aleksa Antić  
**Smer:** Računarsko inženjerstvo (131/23 RI)  
**Institucija:** Računarski fakultet, Univerzitet Union
